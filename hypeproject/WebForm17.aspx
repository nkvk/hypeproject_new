<%@ Page Language="C#" AutoEventWireup="true" Codefile="WebForm17.aspx.cs" Inherits="hypeproject.WebForm17" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="row">
           ...
           <div id="container8">
                        ...
                        <div >
                            <div style="background-color:lightcyan;padding:15px 15px">Article/blog ideas that you can use to generate more traffic, leads, and sales for your business.</div>
                            <br />
                            <div class="submit-field margin-bottom-20">
                                ...
                                <textarea name="description" class="with-border quick-text-counter small-input" data-maxlength="400" 
                                    placeholder="Describe your blog here..." required="" style="height:65px;border-radius:5px;padding:5px 5px"></textarea>
                             </div><br />
                            <div class="submit-field margin-bottom-20">
                                <h4>Language</h4><br />
                            ...
                            <div class="submit-field">
                                ...
                                <input name="max_results" type="number" class="with-border small-input" value="200" min="50" style=""> 
                                
                            </div>
                            
                            <input type="button" style="height:30px;font-size:20px;color:white;background-color:darkblue" value="Generate->"/>
                        </div>
                    </div>
